...
if [ ! -f TrainFNG ]
then
	echo "Error: client binary not found TrainFNG' not found"
	exit 1
fi
if [ ! -f TrainFNG-Server ]
then
	echo "Error: server binary not found TrainFNG-Server' not found"
	exit 1
fi
