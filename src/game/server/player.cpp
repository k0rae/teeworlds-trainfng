...
void CPlayer::Tick()
{
	...
	if(m_pCharacter && m_pCharacter->m_SaveCurrentSpawn)
	{
		m_SpawnPos = m_pCharacter->Core()->m_Pos;
		m_SpawnVel = m_pCharacter->Core()->m_Vel;
		m_pCharacter->m_SaveCurrentSpawn = false;
	}
}
