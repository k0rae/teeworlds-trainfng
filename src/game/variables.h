...
MACRO_CONFIG_INT(SvAllowKill, sv_allow_kill, 1, 0, 1, CFGFLAG_SERVER, "Allow /kill command")
MACRO_CONFIG_INT(SvAllowSpawn, sv_allow_spawn, 1, 0, 1, CFGFLAG_SERVER, "Allow /spawn command")
MACRO_CONFIG_INT(SvAllowSpec, sv_allow_spec, 1, 0, 1, CFGFLAG_SERVER, "Allow /spec command")
